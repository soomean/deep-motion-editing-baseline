...
def generate_database_xia(bvh_path, output_path, window, window_step, dataset_config='xia_dataset.yml'):
    ...
    for i, item in enumerate(bvh_files):
        ...
        content = contents_map[filename.split('_')[0]]
...
def parse_args():
    ...
    parser.add_argument("--bvh_path", type=str, default="../data/xia_generate")
    parser.add_argument("--output_path", type=str, default="../data/xia")
